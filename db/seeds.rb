...
b7 = Book.create(name:"Harry Potter and the Philosopher's Stone", description:"Harry Potter thinks he is an ordinary boy. He lives with his Uncle Vernon, Aunt Petunia and cousin Dudley, who make him sleep in a cupboard under the stairs. Then Harry starts receiving mysterious letters and his life is changed for ever. He is whisked away by a beetle-eyed giant of a man and enrolled in Hogwarts School of Witchcraft and Wizardry. The reason: Harry Potter is a wizard!", star_rating:4, price:1.99, number_of_sales:400, cover_picture:File.open(File.join(Rails.root.join('app/assets/images'), 'philosophers_stone.jpg')), content:'frankenstein.pdf')
...
b9 = Book.create(name:'Harry Potter and the Half-Blood Prince', description:"When Dumbledore arrives at Privet Drive one summer night to collect Harry Potter, his wand hand is blackened and shrivelled, but he does not reveal why. Secrets and suspicion are spreading through the wizarding world, and Hogwarts itself is not safe. Harry is convinced that Malfoy bears the Dark Mark: there is a Death Eater amongst them. Harry will need powerful magic and true friends as he explores Voldemort's darkest secrets, and Dumbledore prepares him to face his destiny.", star_rating:4, price:1.99, number_of_sales:400, cover_picture:File.open(File.join(Rails.root.join('app/assets/images'), 'half_blood_prince.jpg')), content:'frankenstein.pdf')

b10 = Book.create(name:'Harry Potter and the Prisoner of Azkaban', description:"When the Knight Bus crashes through the darkness and screeches to a halt in front of him, it's the start of another far from ordinary year at Hogwarts for Harry Potter. Sirius Black, escaped mass-murderer and follower of Lord Voldemort, is on the run - and they say he is coming after Harry. In his first ever Divination class, Professor Trelawney sees an omen of death in Harry's tea leaves . But perhaps most terrifying of all are the Dementors patrolling the school grounds, with their soul-sucking kiss.", star_rating:4, price:1.99, number_of_sales:400, cover_picture:File.open(File.join(Rails.root.join('app/assets/images'), 'prisoner_of_azkaban.jpg')), content:'frankenstein.pdf')
